...
test.describe('glasdoor Sequential Tests with Shared Context', () => {
  ...
  test('Test 2 - glassdoor Login and Element Check', async ({}, testInfo) => {
    console.log('Test 2');
    testInfo.setTimeout(90000);
    testInfo.slow();
    await page2.bringToFront();
    await page2.goto('https://www.glassdoor.co.in/Job/nodejs-developer-jobs-SRCH_KO0,16.htm?fromAge=1');
  ...
  test('Test 3 - mail all the job listings glassdoor', async () => {
    console.log('Test 3');
    ...
    await page.getByPlaceholder('Email address').fill('ganjiprashanth28@gmail.com');
