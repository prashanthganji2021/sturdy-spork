...
test.describe('2NaUKARIglasdoor Sequential Tests with Shared Context', () => {
  ...
  test('2NaUKARITest 2 - glassdoor Login and Element Check', async ({}, testInfo) => {
    console.log('Test 2');
    testInfo.setTimeout(90000);
    testInfo.slow();
    await page2.bringToFront();
    await page2.goto('https://www.glassdoor.co.in/Job/hyderabad-india-qa-jobs-SRCH_IL.0,15_IC2865319_KO16,18.htm?fromAge=1&minRating=4.0');
  ...
  test('2NaUKARITest 3 - mail all the job listings glassdoor', async () => {
    console.log('Test 3');
